...
//     You initialize count using.reduce(), starting from 0.
// Inside reduce(), you check if cb(el, i) returns true.
// If true, increment acc(the count).
//         Otherwise, return acc unchanged.
//             Finally, you check if count === 1
    
    let count = array.reduce(function(acc, el, i) {
